...
APRS_PASSCODE = 'myAPRSPasscode'
FILTER_DETAILS = "filter g/myEventName\n"

TEST_CLIENT = 'myCallsign-10' # With or without a SSID
...
BAKER_COMMANDS = {
					...
					'sss': ['BakerCmdServerStatus', 1, False], 
...
# windump -A  -c 1000 -nnvvXSs 0 src or dst 10.0.222.99 and port ??? (run windum with the port parameter to determine port currently being used, then start windump again with port parameter set)
